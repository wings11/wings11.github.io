<?php
  ...
  if($_SESSION["cusloggedIn"] != true){
    ...
    $newPassword2=$_POST['txtnewpassword2'];
		$query="SELECT * FROM Customer WHERE CustomerID='$cusid' AND Password='$Password'";
    ...
    if($newPassword1 != $newPassword2)
        {
          ...
          if ($count>0)
          {
            ...
            $sql = "UPDATE customer SET Password='$newPassword1' WHERE CustomerID='$cusid'";
...
<header>
    ...
    <div class="form-container">
        <form action="changepassword.php" method="post">
			...
			<section>
                   <a href="customerhome.php" class="button">Home</a>
                </section>
		</form></div></body>

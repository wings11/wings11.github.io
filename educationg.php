    ...
    <header>
       ...
       <!-- <img class="img-logo"src="ManhuaMyanmar.png" alt="My Logo">-->
        <nav class="navbar">
             ...
             <a class="btn active" href="educationg.php">Education</a>
    ...
    <div class="container1">
        ...
        <?php
            ...
            echo "</tr>";
                ...
                {
                    $searchdata1="SELECT * FROM Book WHERE Type='Education' ORDER BY BookName";
                    ...
                    {
                        $book1="SELECT * FROM Book WHERE Type='Education' ORDER BY BookName LIMIT $c,4";
                        // 0,4  4,4   8,4

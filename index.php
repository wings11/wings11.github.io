    ...
    <header>
       ...
       <!-- <img class="img-logo"src="ManhuaMyanmar.png" alt="My Logo">-->
        <nav class="navbar">
             ...
             <a href="novelsg.php">Novels</a>
             <a href="cartoonsg.php">Cartoons</a>
             <a href="educationg.php">Education</a>
             <a href="othersg.php">Others</a>
        </nav>
        <div class="icons">
...
if (mysqli_num_rows($result3) > 0) {
  ...
  while($rowz = mysqli_fetch_assoc($result3)) {
    ...
    <div class='box' style='background: url(".$rowz["NavBPath"].") no-repeat;'> 
     <div class='content'>
                        <h3>".$rowz["NavBookName"]."</h3>
                        <p>".$rowz["NavBDes"]."</p>
                        <a href='customerlogin.php' class='btn'>Read</a>
                    </div></div></div>
...
?>
            ...
            <div class="srch">
                <form class="navbar-form" method="post" name="form1">
                        ...
                        <button type="submit" name="submit" class="btnbtn">Search
                        </button>                   
                </form>
            </div>
    ...
    <div class="container1">
        ...
        <?php
            ...
            echo "</tr>";
                ...
                {
                    $searchdata1="SELECT * FROM Book ORDER BY BookName";
                    ...
                    { 
                        $book1="SELECT * FROM Book ORDER BY BookName LIMIT $c,4";
                        // 0,4  4,4   8,4
                        ...
                        echo "<tr>";
                            ...
                            ?>
                                <td>
                                    ...
                                    <a href="bookdetail.php?BookID=<?php echo $bookid ?>">
                                    <div class="box"><img src="<?php echo $row1['BPath']; ?>">
                <div class="content">
                    <h4><?php echo $row1['BookName']; ?></h4>
                    <h3><?php echo $row1['Author']; ?></h3>

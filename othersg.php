...
<a href="customerhome.php" class="logo"><img src="images/favicon.ico">ReadBooks</a>
       <!-- <img class="img-logo"src="ManhuaMyanmar.png" alt="My Logo">-->
        <nav class="navbar">
             ...
             <a class="btn active" href="othersg.php">Others</a>
        </nav>
        <div class="icons">
    ...
    <div class="container1">
        ...
        <?php
            ...
            echo "</tr>";
                ...
                {
                    $searchdata1="SELECT * FROM Book WHERE Type='Other' ORDER BY BookName";
                    ...
                    {
                        $book1="SELECT * FROM Book WHERE Type='Other' ORDER BY BookName LIMIT $c,4";
                        // 0,4  4,4   8,4
